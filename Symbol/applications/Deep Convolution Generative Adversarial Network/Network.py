...
def DCGAN(epoch,noise_size,batch_size,save_period,dataset,load_weights):
...
if __name__ == "__main__":
    ...
    DCGAN(epoch=100, noise_size=100, batch_size=128, save_period=100, dataset='ImageNet',load_weights=100)

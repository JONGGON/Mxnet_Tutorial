...
parser.add_argument("-l","--load_weights",type=int,help="Load weights")
args = parser.parse_args()

if args.state:
    print(args.state)
    Network.DCGAN(epoch=args.epoch, noise_size=args.noise_size, batch_size=args.batch_size, save_period=args.save_period,dataset=args.dataset , load_weights=args.load_weights)
else:
    #dataset : MNIST, CIFAR10 , Imagenet
    Network.DCGAN(epoch=1, noise_size=100, batch_size=128, save_period=100,dataset='CIFAR10',load_weights=100)

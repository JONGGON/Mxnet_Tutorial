...
class RNNCell(BaseRNNCell):
    ...
    def parameter(self):
        parameter={}
        parameter['i2h_weight'] = self._iW
        parameter['i2h_bias'] = self._iB
        parameter['h2h_weight'] = self._hW
        parameter['h2h_bias'] = self._hB
    ...
    '''
    To change the output size of 'RNN Cell', modify the code below.
    '''
    def __call__(self, inputs, states):
        self._counter += 1
...
class LSTMCell(BaseRNNCell):
    ...
    '''
    To change the output size of 'LSTM Cell', modify the code below.
    '''
    def __call__(self, inputs, states):
        self._counter += 1
        name = '%st%d_'%(self._prefix, self._counter)
...
class GRUCell(BaseRNNCell):
    ...
    '''
    To change the output size of 'GRU Cell', modify the code below.
    '''
    def __call__(self, inputs, states):
...
class ZoneoutCell(ModifierCell):
    ...
    def __init__(self, base_cell, zoneout_outputs=0., zoneout_states=0.):
        assert not isinstance(base_cell), \

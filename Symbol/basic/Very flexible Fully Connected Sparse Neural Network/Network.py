...
def NeuralNet(epoch,batch_size,save_period,load_weights,ctx=mx.gpu(0)):
    ...
    weight1 = mx.symbol.Variable('weight1', stype='row_sparse', shape=(784, 100))
    bias1 = mx.symbol.Variable('bias1', shape=(100,))
    weight2 = mx.symbol.Variable('weight2', stype='row_sparse', shape=(100, 10))
    bias2 = mx.symbol.Variable('bias2', shape=(10,))

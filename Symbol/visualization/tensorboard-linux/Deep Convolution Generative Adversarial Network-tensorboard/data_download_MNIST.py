...
if __name__ == "__main__":
    ...
    '''
    (train_lbl_one_hot, train_lbl, train_img) = read_data_from_file('MNIST/train-labels-idx1-ubyte.gz','MNIST/train-images-idx3-ubyte.gz')
    (test_lbl_one_hot, test_lbl, test_img) = read_data_from_file('MNIST/t10k-labels-idx1-ubyte.gz','MNIST/t10k-images-idx3-ubyte.gz')
    ...
    print "Load the mnist data from the outside"

...
def DCGAN(epoch = 100, batch_size=128, save_period=10, load_period=100, optimizer="adam", beta1=0.5, learning_rate= 0.0002 , dataset = "MNIST", ctx=mx.gpu(0)):
    ...
    if dataset == "CIFAR10":
        ...
        G_path = "weights/MNIST-G{}.params".format(load_period)
        D_path = "weights/MNIST-D{}.params".format(load_period)
    else:
    ...
    for i in tqdm(range(1,epoch+1,1)):
        for data , label in train_data:
            ...
            with autograd.record(train_mode=True):
                ...
                #(2)
                fake_real=generator(target_noise)
        ...
        if i % save_period==0:
            ...
            if dataset=="MNIST":
                generator.save_params("weights/MNIST-G{}.params".format(i))
                discriminator.save_params("weights/MNIST-D{}.params".format(i))
            elif dataset=="CIFAR10":
...
if __name__ == "__main__":
    DCGAN(epoch=1, batch_size=128, save_period=100, load_period=100, optimizer="adam", beta1=0.5, learning_rate=0.0002,dataset="MNIST", ctx=mx.gpu(0))
else :
    print("Imported")
